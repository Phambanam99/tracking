          ...
          <div className="absolute top-full right-0 mt-2 w-96 bg-white rounded-lg shadow-xl border border-gray-200 p-6">
            ...
            {activeFilterTab === 'vessel' && (
              <>
                ...
                <div className="mb-4 flex items-center justify-between bg-yellow-50 p-2 rounded border border-yellow-200">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium text-gray-700">
                      Hiển thị tàu dự đoán
                    </span>
                    <span className="text-xs text-gray-500">(mất tín hiệu)</span>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={showPredictedVessels}
                      onChange={(e) => setShowPredictedVessels(e.target.checked)}
